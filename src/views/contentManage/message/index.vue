  ...
  <div class="container">
    <div class="header" ref="header">
      <div class="search-container clearfix">
        ...
        <div class="search-item search-ipt">
          <el-select placeholder="类型" size="medium" v-model="filter.typecode" clearable>
            <el-option v-for="item in noticeCategory" :key="item.id" :label="item.text" :value="item.id"></el-option>
          </el-select>
        </div>
        <div class="search-item search-ipt">
    ...
    <div class="main">
      <div class="table-container">
        <el-table
          ...
          <el-table-column label="发布日期" prop="creationdate" :formatter="handleCreationdate"></el-table-column>
      ...
      <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="820px">
        <div class="dialog-container" v-loading="imgLoading">
          <div class="dialog-main">
            <div class="row">
              <div class="column">
                ...
                <div class="ipt-medium">
                  <el-input size="medium" placeholder="" v-model="noticeInfo.caption" clearable></el-input>
              ...
              <div class="column">
                ...
                <div class="ipt-medium">
                  <el-select size="medium" placeholder="类型" v-model="noticeInfo.categoryid">
                    <el-option v-for="item in noticeCategory" :key="item.id" :label="item.text" :value="item.id"></el-option>
                  </el-select>
                  <div class="danger-text" v-if="formErr && !noticeInfo.categoryid">类型不可为空</div>
                </div>
              </div>
              <div class="column">
            ...
            <div class="row">
              <div class="column">
                <div class="label">公告描述</div>
                <div class="ipe-medium">
                  <el-input type="textarea" placeholder="公告描述" :rows="3" v-model="noticeInfo.webContent" clearable=""></el-input>
                  <!--                  <div class="danger-text" v-if="formErr && !questionInfo.webContent">公告描述不可为空</div>-->
                </div>
              </div>
              <div class="column">
...
export default {
  ...
  methods: {
    ...
    // 发布日期 -- 过滤
    handleCreationdate (row, column, cellValue) {
    ...
    getNoticeDetail (id) {
        ...
        this.noticeInfo.webContent = res.obj.webContent
    ...
    switchDialog (param) {
      ...
      if (param) {
        ...
        this.dialogTitle = '修改'
        this.isCreate = false
        this.noticeInfo.caption = param.name
        this.noticeInfo.context = ''
        this.noticeInfo.categoryid = param.categoryid
        this.noticeInfo.webContent = param.webContent
        this.noticeInfo.filepath = param.filepath
        this.channel = param.channel ? param.channel.split(',') : []
        this.imgUrl = param.filepath
    ...
    // 必填项判断
    paramJudge () {
      if (this.noticeInfo.caption && this.noticeInfo.context && this.channel.length) {
        this.formErr = false
