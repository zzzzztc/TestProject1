<template>
  <div id="NoSeatReport" class="container">
    ...
    <div class="main">
      <div class="table-container">
        <el-table
          ...
          <el-table-column label="订单号" prop="ordercode" min-width="110"></el-table-column>
          <el-table-column label="PNR" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="订单日期" prop="creadate" min-width="110"></el-table-column>
...
<script>
	...
	import { queryNoSeatReport } from './api.js'
	...
	export default {
		...
		methods: {
			...
			fetchList (page, pageSize) {
				...
				queryNoSeatReport(this.filter).then(res => {
					this.tableList = res
					this.loading = false
				}).catch(err => {
					this.loading = false
			...
			exportExcel () {
				...
				let params = {
					data: data,
					url: 'noSeat/exportNoSeatReport',
					name: getRouteName('/noSeatReport'),
					type: 'xls'
				}
